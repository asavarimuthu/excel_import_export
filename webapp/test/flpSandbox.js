		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapexcelexportimport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapexcelexportimport-display": {
								"semanticObject": "comsapexcelexportimport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.excelexportimport",
									"url": sap.ui.require.toUrl("com/sap/excelexportimport")
								}
							}
						}
					}
